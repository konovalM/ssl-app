...
(function($) {
  ...
  $('.tabs__link').click(function(e) {
    ...
    $('.entrance-link__account').hide();
    $('.entrance-info').hide();
    $('.account-body').addClass('tab-open');
  });
  $('.close-tab').click(function(e) {
    e.preventDefault;
    $('.tabs__wrap').find('.tabs__link').removeClass('active')
    $('.tabs__panel').removeClass('active');
    $('.entrance-link__account').show();
    $('.entrance-info').show();
    $('.account-body').removeClass('tab-open');
  });

  // accordeon ==================================================
    $('.accordeon__item:not(.active) .accordeon__content').hide();
    $('.accordeon__title').click(function () {
      $(this).parent().toggleClass('active');
      $(this).parent().siblings('.accordeon__item').not($(this).parent()).removeClass('active');
      $(this).parent().siblings('.accordeon__item').children('.accordeon__content').slideUp();
    ...
    if ($(window).width() <= 576) {
        $('.sertificates-table__row .open-arrow, .sertificates-table__row .domains').click(function(){
            $(this).parent().toggleClass('active');
        })
    }
...
/*const mainWrap = document.querySelector('.main-body');
const registrationPopup = document.createElement('div');
registrationPopup.classList.add('registrationSuccess')
const cross = document.createElement('div')
cross.classList.add('cross')
/!*cross.style.cssText = `
                      width: 17px;
                      height: 17px;
                      background: url("data:image/svg+xml,%3Csvg width='17' height='17' viewBox='0 0 17 17' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M10.3274 8.49838L16.6183 2.20951C17.1229 1.70485 17.1229 0.886394 16.6183 0.378497C16.1138 -0.126166 15.2955 -0.126166 14.7877 0.378497L8.49677 6.6706L2.20909 0.378497C1.70453 -0.126166 0.886225 -0.126166 0.378425 0.378497C-0.126142 0.883159 -0.126142 1.70162 0.378425 2.20951L6.66933 8.50162L0.378425 14.7905C-0.126142 15.2951 -0.126142 16.1136 0.378425 16.6215C0.882991 17.1262 1.70129 17.1262 2.20909 16.6215L8.5 10.3294L14.7909 16.6215C15.2955 17.1262 16.1138 17.1262 16.6216 16.6215C17.1261 16.1168 17.1261 15.2984 16.6216 14.7905L10.3274 8.49838Z' fill='white'/%3E%3C/svg%3E") center/contain no-repeat;
                      margin: 25px auto 0;
                      cursor: pointer;
                      `*!/
cross.addEventListener('click', () => {
    registrationPopup.style.cssText = `
        display: none;
    `
})
const registrationText = document.createElement('div')
registrationText.classList.add('registrationText')
registrationText.innerText = 'you have successfully registered'
/!*registrationText.style.cssText = `
                                  font-size: 16px;
                                  line-height: 50px;
                                  text-align: center;
                                  ...
                                  margin-top: 10px;
                                  `*!/
registrationPopup.insertAdjacentElement('afterbegin', cross)
registrationPopup.insertAdjacentElement('beforeend', registrationText)
registrationPopup.classList.add('registrationPopup')
/!*registrationPopup.style.cssText = `
                                  animation-name: registrationSuccess;
                                  ...
                                  `;*!/
mainWrap.insertAdjacentElement('afterbegin', registrationPopup)*/
